"""In-memory metrics since process start (requests_total, cache_hits_total, weaviate_fallback_total, avg_latency_ms)."""
...
def record_request(
    ...
    if weaviate_fallback:
        _metrics["weaviate_fallback_total"] = _metrics.get("weaviate_fallback_total", 0) + 1
...
def get_metrics() -> dict[str, int | float]:
    ...
    return {
        ...
        "weaviate_fallback_total": _metrics.get("weaviate_fallback_total", 0),
...
def reset_metrics() -> None:
    ...
    _metrics["weaviate_fallback_total"] = 0
